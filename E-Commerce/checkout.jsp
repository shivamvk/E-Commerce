  ...
  %>
    <%
       	while(rs.next()){
			...
			<td style="vertical-align:middle"><a href="actionDeleteFromCart.jsp?productId=<%=rs.getString(2) %>&calledBy=checkout.jsp" class="btn btn-sm btn-danger">Remove</a></td>
			</tr>										
       		<%
       	}
    con.close();
...
<div class="row">
  <div class="col-75">
    <div class="container">
      <form action="actionSendMail.jsp" method="get">
